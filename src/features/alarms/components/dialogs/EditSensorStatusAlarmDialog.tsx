...
export function EditSensorStatusAlarmDialog({
    ...
    const handleSentMessageChange = (value: string) => {
        setForm(prev => ({ ...prev, sentMessage: value }));
        setHasChanges(true);
    };
            ...
            >
                ...
                <div style={scrollContainerStyle}>
                    <div className="space-y-6">
                        ...
                        <div className="space-y-2">
                            <Label>{t('alarms.sentMessage')}</Label>
                            {currentAlarm ? (
                                <Input type="text" value={currentAlarm.sentMessage} disabled />
                            ) : (
                                <Input
                                    type="text"
                                    value={sentMessage || ''}
                                    onChange={(e) => {
                                        handleSentMessageChange(e.target.value);
                                        setHasChanges(true);
                                    }}
                                />
                            )}
